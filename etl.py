...
def process_song_data(spark, input_data, output_data):
    """
    This function processes song data by reading it from json files,
    atransforming it into the desired format and writing it back to parquet files
    """
...
def process_log_data(spark, input_data, output_data):
    """
    This function processes log data by reading it from json files,
    atransforming it into the desired format and writing it back to parquet files
    """
    ...
    time_table = df.select('timestamp', 'hour', 'day', 'week', 'month', 'year', 'weekday').dropDuplicates()
